...
def segment(textFileName, plotting = False, window=2, numberOfPointsInWindow=5, increment=2, threshholdFilter=50):
    ...
    if plotting:
        plot(magnitudes, modes, sma, smaWithNan, timestamp)
    ...
    all_Moves_With_axis = get_All_Moves_With_axis(allMoves, magnitudes, x, y, z)
    # if plotting:
...
def plot(magnitudes, modes, sma, smaWithNan, timestamp):
